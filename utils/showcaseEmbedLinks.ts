/** to update these links, go to the YouTube video you want to embed,
 * click "Share", then "Embed", and copy the link in the src attribute
 * of the iframe tag */
...
export const showcaseEmbedLinks = [
    ...
    "https://www.youtube.com/embed/FZI4T7TFS6s?si=4YMnQB67mgzkgFlU", // ICCA 2018 South Semifinals
];
