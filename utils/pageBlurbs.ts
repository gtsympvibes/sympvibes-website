...
const auditionHomePageText4 =
    "We look forward to seeing you at auditions! For more information, click the button below!";

export const auditionHomePageText = [
    auditionHomePageText1,
    auditionHomePageText2,
    auditionHomePageText3,
    auditionHomePageText4,
];
...
export const auditionSteps = [
    {
        title: "Warm Ups",
        description:
            "We'll run through some vocal warm ups to get you started, assess your range, and so you can get a glimpse at how we start each rehearsal!",
    },
    {
        title: "Tonal Memory",
        description:
            "We'll play some short melodies and ask you to sing them back to us to assess your tonal memory and how well you learn by ear.",
    },
    {
        title: "1-minute Solo",
        description:
            "We'll ask you to sing a 1-minute solo of a song of your choice. This is your chance to show us your personality and stage presence!",
    },
    {
        title: "Callbacks",
        description:
            "If the initial audition goes well, we'll invite you for callbacks. This is your chance to learn a song with the whole group, and sing a solo from our set list!",
    },
];
...
export const musicBlurb =
    "Our group has been working on music projects for a while now. Outside of our regular performances on the Georgia Tech campus and the Greater Atlanta area, we have also been working on recording and releasing music. Here are some of our albums, which can all be found on our Spotify as well:";
